...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-29 07:22`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0a887365-c427-463a-85a4-f30da5422bcd.git
$ cd 0a887365-c427-463a-85a4-f30da5422bcd
```
